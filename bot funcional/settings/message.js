...
"Por que o livro de matemática se apaixonou pelo livro de história? Porque juntos, eles formavam uma grande história de amor.",
"Qual é o animal mais antigo do mundo? O Zebrafante, porque ele é o avô de todos os peixes.",
"Por que o pombo não usa drogas? Porque ele já tem crack.", 
"Qual é o animal que tem mais patas? A mesa, porque ela tem quatro pés!", 
"Por que o carro foi ao médico? Porque ele estava engasgando com o escapamento.", 
"Qual é o doce preferido do vampiro? Dentadura de alho.", 
"O que o tomate foi fazer no banco? Foi tirar extrato.", 
"Por que o elefante não usa computador? Porque ele tem medo do mouse.", 
"Qual é o peixe que usa óculos? O peixe miopia.", 
"Por que o livro de receitas se suicidou? Porque ele não aguentava mais ser virado.", 
"O que a mãe tomate disse para o filho tomate? Ketchup!", 
"Qual é o animal mais estudioso? O buvete, porque ele vive no mar e sabe tudo de água.",
"Por que a matemática é tão complexa? Porque ela tem muitos problemas.", 
"Qual é o alimento mais aventureiro? O arroz, porque ele se arrisca na panela de pressão.", 
"Por que o chuveiro não vai à escola? Porque ele já é um sabonete.", 
"O que o pato falou para a pata? Vem quá!", 
"Qual é o animal mais fashion? A zebra, porque ela está sempre na moda.", 
"Por que a bicicleta caiu? Porque estava sem equilíbrio.", 
"Onde o Batman vai ao banheiro? No Bat-si.", 
"Qual é o lugar mais silencioso do mundo? A loja de instrumentos musicais, porque lá os músicos não podem tocar."
]
...
msg: {
  grupo: 'Este comando só pode ser utilizado em grupos jumento (a)😤.',
  premium: 'Este comando é exclusivo para humanos superiores, não seja insolente humano inferior😌.',
  mod: 'Este comando é específico para o meu dono o animal 😒.',
  banido: 'Você foi banido de utilizar os meus comandos.' ,
  donosmt: 'Desculpe, mas apenas o meu dono pode utilizar esse comando 🤫.',
  donosmt2: 'Desculpe, mas apenas o meu dono pode utilizar esse comando 🤫.',
  adm: 'Apenas seres superiores podem usar esse comando em grupo 😘.',
